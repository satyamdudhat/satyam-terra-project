...
resource "aws_lambda_permission" "apigw_lambda" {
  ...
  source_arn = "${aws_api_gateway_rest_api.serverless_demos.id}/*/${aws_api_gateway_method.serverless_demos_method.http_method}${aws_api_gateway_resource.serverless_demos_resource.path}"
}
